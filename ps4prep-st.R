...
getwd()
# 8bis. Did you copy the command? I told you to type. Erase and type. Save by clicking CTRL + S (or CMD + S on mac), keep the cursor on the same command line and click on your keyboard CTRL + ENTER (or CMD + ENTER on mac).
